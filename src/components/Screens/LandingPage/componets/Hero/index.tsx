...
const HeroSection = () => {
  ...
  return (
    <div dir={dir} className='w-full h-full flex justify-center gap-x-16 items-center'>
      <div className='w-[40%] px-[54px]'>
        ...
        <Button localeId='landingpage.hero.cta' title='Become a sponsor' className='max-w-[200px]'  />
      </div>
      <div>
