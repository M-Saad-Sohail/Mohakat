...
const Button: React.FC<IProps> = ({
	...
	return (
		<button
			...
			} rounded-xl shadow-custom font-semibold md:text-sm text-[13px] border-2 border-transparent outline-none md:py-2 py-2 w-fit transition-colors duration-300 ease-in-out  ${className}`}
			style={{
